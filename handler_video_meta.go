...
func (cfg *apiConfig) handlerVideoGet(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		respondWithError(w, http.StatusInternalServerError, "Error generating signed video URL 2", err)
		return
	}
...
func (cfg *apiConfig) handlerVideosRetrieve(w http.ResponseWriter, r *http.Request) {
	...
	for i, video := range videos {
		...
		if err != nil {
			respondWithError(w, http.StatusInternalServerError, "Error generating signed video URL 3", err)
			return
		}
